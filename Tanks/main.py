...
background = pygame.image.load(os.path.join(PATH, 'images/background.jpg'))
background = pygame.transform.scale(background, (SCREEN_WIDTH, SCREEN_HEIGHT))

font = pygame.font.Font(None, 120)
winner1_text = font.render('YELLOW WIN', True, (255,255,0))
winner2_text = font.render('GREEN WIN', True, (0,250,1))

mixer.init()
volume_value = 0.5
mixer.music.set_volume(volume_value)
mixer.music.load('sounds/back_music.wav')
mixer.music.play()
fire_sound = mixer.Sound('sounds/strike.wav')

x = 0
y = 0
blocks_list = []

wall_image1 = os.path.join(PATH, 'images/wall.jpg')
wall_image2 = os.path.join(PATH, 'images/wall1.jpg')
